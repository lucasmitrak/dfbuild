...
These changes were made to disable the default soundtrack in favor of SoundSense, show and potentially increase the FPS, and disable the default intro.  In addition, the default font and fullfont were changed for Phoebus.
